...
isr_common:
    ...
    push esp ; pass the pointer to the stack
    call isr_handler
    add esp, 4 ; clear the pushed esp
    ...
    popa
    add esp, 8 ;remove all the interrupt stuffs
